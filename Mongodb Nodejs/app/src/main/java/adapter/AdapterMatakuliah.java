...
import com.example.mongodbnodejs.ListMatakuliah;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        btnDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("kodemk", item.get(position).getKodeMk());
                i.putExtra("namamk", item.get(position).getNamaMk());
                i.putExtra("jam", item.get(position).getJam());
                i.putExtra("hari", item.get(position).getHari());
                i.putExtra("ruang", item.get(position).getRuang());
                i.putExtra("nidn", item.get(position).getNidn());
                i.putExtra("namadosen", item.get(position).getDosen());
